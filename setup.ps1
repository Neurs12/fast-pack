...
$jreRunner = $jre.BeginInvoke() | Out-Null
...
$launcherRunner = $launcher.BeginInvoke() | Out-Null
...
$fastPackRunner = $fastPack.BeginInvoke() | Out-Null
...
$installJreRunner = $installJre.BeginInvoke() | Out-Null
...
$applyPackRunner = $applyPack.BeginInvoke() | Out-Null
